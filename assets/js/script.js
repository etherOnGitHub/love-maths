...
function displaySubtractQuestion(operand1, operand2) {
    document.querySelector("#operand1").innerText = operand1 > operand2 ? operand1 : operand2;
    document.querySelector("#operand2").innerText = operand1 > operand2 ? operand2 : operand1;
    document.querySelector("#operator").innerText = "-";
}
